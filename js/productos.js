...
class ProductoView {
            ...
            <div class="row mt-3">
                <div class="col-12 col-md-4">
                    ...
                    <section>
                        ...
                        <button id="btnEnviar" class="btn-estilo">ENVIAR</button>
                    </section>
                    </div>
                </div>
            </div>
    ...
    mostrarBusqueda(padre, data, callback) {
        let html = "";
        for (const producto of data) {
            html += `<div>
                        <input value="${producto.id}" type="hidden">
...
class ProductoController {
    ...
    //MÊTODO PARA GENERAR CONTROLAR LA VISTA, EL MODELO Y EL EVENTO AL AGREGAR UN PRODUCTO
    agregar(app) {
    ...
    listar(app) {
        this.productoView.listarProductos(app, this.productoModel.productos, (event) => {
            let hijos = $(event.target).parent().children();
            console.log("producto id: ", hijos[0].value);
        });
    }
